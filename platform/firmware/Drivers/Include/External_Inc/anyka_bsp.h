...
#error "CHIP_AK9801 or CHIP_AK9805 Not support RAM larger than 512M bytes"
#endif
...
#define IRQ_MODE_STACK_SIZE     (0x2000)
#define FIQ_MODE_STACK_SIZE     (0x10)  /* if has FIQ, enlarge it */
#define ABORT_MODE_STACK_SIZE   (0x400)
#define UNDEF_MODE_STACK_SIZE      (0x400)
