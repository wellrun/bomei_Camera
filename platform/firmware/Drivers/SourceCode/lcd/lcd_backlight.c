...
#ifdef CHIP_AK3760
    T_PWM_ID pwnSelect =uiPWM1;
#else
    T_PWM_ID pwnSelect =uiPWM2;
#endif    
    
    switch(brightness)
    {
		case 0:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 0);
			break;
		case 1:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 30); 
			break;
		case 2:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 40);
			break;
		case 3:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 50);
			break;
		case 4:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 55);
			break;
		case 5:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 60);
			break;
		case 6:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 70);
			break;
		case 7:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 80);
			break;
		default:
			pwm_set_duty_cycle(pwnSelect, pwm_freq, 55);
			break;
