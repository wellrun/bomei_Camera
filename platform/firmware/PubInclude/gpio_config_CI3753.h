...
#define GPIO_MMC_DETECT             21
#define GPIO_SD_DETECT              20
#define GPIO_HEADSET_DETECT         18
...
#define GPIO_KEYAPD_ROW2            INVALID_GPIO // 47
...
#define GPIO_KEYAPD_COLUMN3         INVALID_GPIO // 48
...
#define GPIO_INNO_POWER             INVALID_GPIO//0
#define GPIO_INNO_CS				INVALID_GPIO
#define GPIO_SPEAKER_EN				INVALID_GPIO//0

#define GPIO_I2C_SCL                6 
#define GPIO_I2C_SDA                5

#define GPIO_POWER_OFF              INVALID_GPIO
#ifdef SPIBOOT
...
#define GPIO_USB_DRV_BUS            27

#define GPIO_SWITCH_KEY             INVALID_GPIO	// 48	 
