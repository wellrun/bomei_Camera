 ...
 *	  设为INVALID_GPIO即可
 */
#ifndef __GPIO_CONFIG_CI3760_H__
#define __GPIO_CONFIG_CI3760_H__
...
#ifdef SPIBOOT
#define GPIO_CAMERA_RESET           1//13 //用硬件控制
#define GPIO_CAMERA_CHIP_ENABLE     INVALID_GPIO
#else
#define GPIO_CAMERA_RESET           1//16 //用硬件控制
#define GPIO_CAMERA_CHIP_ENABLE     INVALID_GPIO
#endif
...
#define GPIO_MAC_PWR    INVALID_GPIO
#define GPIO_MAC_RST    86
...
#endif //#ifndef __GPIO_CONFIG_CI360_H__
