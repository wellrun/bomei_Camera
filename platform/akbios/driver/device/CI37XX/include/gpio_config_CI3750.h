...
#define GPIO_KEYAPD_ROW0            19
#define GPIO_KEYAPD_ROW1            20
#define GPIO_KEYAPD_ROW2            21 //just for 3X4

#define GPIO_KEYAPD_COLUMN0         18
#define GPIO_KEYAPD_COLUMN1         47
#define GPIO_KEYAPD_COLUMN2         4
#define GPIO_KEYAPD_COLUMN3         INVALID_GPIO //PU 3.3V //just for 3X4
