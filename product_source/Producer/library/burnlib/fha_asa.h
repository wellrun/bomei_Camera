 ...
 * FUNCTION  check the nand is used or not
 * PARAM:    [in] buf -- the buf out malloc
 *                [in] data_len --- pagesize
 * RETURN:   is used return ASA_FILE_SUCCESS, not retuen ASA_FILE_FAIL
**************************************************************************/
T_BOOL  FHA_check_Nand_isused(T_U8 *pBuf, T_U32 len);

/************************************************************************
 * NAME:     FHA_Get_factory_badblock_Buf
 * FUNCTION  get the factory bad block buf
 * PARAM:[out]buf ------ buffer used to store information data
 *           [in] data_len --- page num
 * RETURN:   success return ASA_FILE_SUCCESS, fail retuen ASA_FILE_FAIL
**************************************************************************/
