...
public:
	...
	void UpdateWindow();//UpdateWindow
	BOOL m_bEraseBkgnd;
	UINT GetStyle();//GetStyle
	void SetStyle(UINT style);//SetStyle
	void DrawFrame(CDC *pDC);//DrawFrame
	void* GetPageItem(UINT nIndex);//GetPageItem
	void SetActivePage(int nIndex);//SetActivePage
	...
	void AutoSize();//AutoSize
	void GetClientRect(LPRECT lpRect );//GetClientRect
