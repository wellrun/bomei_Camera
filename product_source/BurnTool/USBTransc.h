...
USBTRANSC_API void BT_CreateSemaphore(VOID);
...
/**
 * @brief BT_Get_Auto_flag
 *
 * @author luqiliu
 * @date 2012-06-20
 * @param[in] BOOL Auto_flag
 * @return void
 */
USBTRANSC_API void BT_Get_Auto_flag(BOOL Auto_flag);
