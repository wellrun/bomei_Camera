...
//	TCHAR			g_mac_current_high[32][MAX_MAC_SEQU_ADDR_COUNT+1];
	...
	//OTP序列号
	TCHAR			g_OTP_serial_current[32][MAX_MAC_SEQU_ADDR_COUNT+1];
	TCHAR			g_OTP_serial_show_current[32][MAX_MAC_SEQU_ADDR_COUNT+1];
	TCHAR           OTP_serial_current[MAX_MAC_SEQU_ADDR_COUNT+1];
	TCHAR			OTP_serial[MAX_MAC_SEQU_ADDR_COUNT+1];
	BOOL			OTP_serial_flag; //是否烧录标志
	...
	TCHAR			path_nandretry[MAX_PATH+1];
