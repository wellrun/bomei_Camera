 ...
 * @retval BT_SUCCESS or BT_FAIL
 */
TRANSC_API UINT   BT_SetTranscParam(UINT nID, T_TRANSC_PARA *para);
 ...
 * @retval BT_SUCCESS or BT_FAIL
 */
TRANSC_API UINT   BT_Get_nandretry_path(TCHAR *trancePath);

/**
 * @brief read otp serial.
 *
 * @author lixingjian
 * @date 2014-05-22
 * @param[in] nID index of burn channel.
 ...
 * @retval BT_SUCCESS or BT_FAIL
 */
TRANSC_API UINT  BT_Read_OTP_Serial(UINT nID, BYTE* pBuf, UINT bufSize);
/**
 * @brief write otp serial.
 *
 * @author lixingjian
 * @date 2014-05-22
 * @param[out] nID index of burn channel.
 * @param[out] pBuf data buffer of file.
 * @param[out] bufSize buffer size.
 * @return UINT.
 * @retval BT_SUCCESS or BT_FAIL
 */
TRANSC_API UINT  BT_Write_OTP_Serial(UINT nID,  BYTE* pBuf, UINT bufSize);
