...
typedef enum
{
	...
	MESSAGE_READ_OTP_SERIAL,                 //读OTP区序列号
	MESSAGE_READ_OTP_SERIAL_FAIL,            //读OTP区序列号失败
	MESSAGE_WRITE_OTP_SERIAL,                //写OTP区序列号
	MESSAGE_WRITE_OTP_SERIAL_FAIL,           //写OTP区序列号失败
	MESSAGE_OTP_SERIAL_EXIST,                //opt序列号已存在
	MESSAGE_BURN_OTP_SERIAL_SHOW,            //显示
