...
T_BOOL FS_Malloc_Burn_nID_Idex(T_U32 burn_nID);
T_BOOL FS_Free_Burn_nID_Idex(T_U32 burn_nID, T_U8  MediumType);



T_BOOL FS_GetDriver_Burn(PDRIVER_INFO pDriverInfo, T_U8 DriverID, T_U32 nID);
