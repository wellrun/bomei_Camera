...
{
    volatile T_BOOL usb_dma1_int;
    volatile T_BOOL usb_dma2_int;
    volatile T_BOOL usb_dma3_int;
    volatile T_BOOL usb_ep0_int;
    volatile T_BOOL usb_ep1_int;
    volatile T_BOOL usb_ep2_int;
    volatile T_BOOL usb_ep3_int;
};
