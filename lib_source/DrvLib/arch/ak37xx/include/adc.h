...
//ANALOG_CONTROL_REG4
#define PL_VCM3          (1 << 0)  //pull down vcm3 with a 2Kohm resistor to ground
#define PD_ADC2          (1 << 1)  //power off adc2
#define PD_LINEIN        (3 << 13) //power off linein
...
#define PD_MICP          (1 << 23) //power off mono mic
#define PD_MICN          (1 << 24) //power off differential mic
#define VCM3OUT_SEL      (1 << 25) //disconnect the AVCC and vcm3
