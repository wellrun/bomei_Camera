...
#define NF_REG_CTRL_STA_CE2_SEL   (1 << 12)
#define NF_REG_CTRL_STA_CE3_SEL   (1 << 13)
...
/*  write data cycle's:
 *      CMD_END=X, ALE=0, CLE=0, CNT_EN=1,  (BIT[0:3])
 *      REN=0, WEN=1, CMD_EN=0, STAFF_EN=1, (BIT[4:7])
 *      DAT_EN=0, RBN_EN=0, CMD_WAIT=0,     (BIT[8:10])
 */
#define WRITE_INFO_CONF         0xA8
...
#define NFLASH_READ3                0x05
#define NFLASH_READ4                0xE0
#define NFLASH_READ1_HALF           0x01
#define NFLASH_READ22               0x50
#define NFLASH_CACHE_READ1          0x31
#define NFLASH_CACHE_READ2          0x3F
#define NFLASH_2P_CACHE_READ        0x33
...
#define NFLASH_FRAME_PROGRAM2       0x15
#define NFLASH_2P_DUMMY_PROGRAM1    0x11    //for two plane operation only
#define NFLASH_2P_DUMMY_PROGRAM0    0x81    //for two plane operation only
