...
//common
#define         AK_EFAILED                      1     /*Common operate failed*/
#define         AK_ENOMEMORY                    2     /*No enough memory to alloc*/
#define         AK_EBADPARAM                    3     /*Bad params*/
#define         AK_EUNSUPPORT                   4     /*Unsupport operation*/
#define         AK_EBADCLASS                    5     /*Bad class or type*/
#define         AK_ENOTFOUND                    6     /*Not found*/
#define         AK_EEXISTED                     7     /*The Item existed*/
#define         AK_EINVALIDOPT                  8     /*Invalid operation*/
#define         AK_ENOTCREATED                   9    /*Not Created */ 
...
#define AK_IS_VALIDHANDLE(handle)     ((handle > 0) || (handle < -100))
#define AK_IS_INVALIDHANDLE(handle)   ((handle <= 0) && (handle > -100))
