...
sub printMake
{
    ...
    print FMAK "ifeq (\$(ARM_GCC), 3.4.3)\n";
	print FMAK "\#gcc version 3.4.3\n";
	print FMAK "\ARM_LIBC_PATH   = c:/cygwin/tools/GNUARM/arm-elf/lib\n";
	print FMAK "\ARM_LIBGCC_PATH = c:/cygwin/tools/GNUARM/lib/gcc/arm-elf/3.4.3\n";
	print FMAK "else\n";
    print FMAK "\#gcc version 3.0\n";
    print FMAK "ARM_LIBC_PATH     = c:/cygwin/tools/H-i686-pc-cygwin/arm-elf/lib\n";
	print FMAK "ARM_LIBGCC_PATH   = c:/cygwin/tools/H-i686-pc-cygwin/lib/gcc-lib/arm-elf/3.0\n";
	print FMAK "endif\n\n";
...
CFLAGS 	= -mlittle-endian -fno-builtin -nostdlib $(DEFINE) -O2 -mlong-calls $(INCLUDE)
ASFLAGS = -mlittle-endian -x assembler-with-cpp $(DEFINE) -O2 $(INCLUDE)
#define
DEFINE		= -DOS_ANYKA=1
